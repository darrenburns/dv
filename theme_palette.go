...
func NewThemePalette(theme t.ThemeData) ThemePalette {
	...
	roleStyles := map[TokenRole]t.SpanStyle{
		...
		TokenRoleSyntaxIdentifier:   {Foreground: theme.Text},
		TokenRoleSyntaxConstant:     {Foreground: theme.Warning},
		TokenRoleSyntaxBuiltin:      {Foreground: theme.Primary},
		TokenRoleSyntaxPreprocessor: {Foreground: theme.Error},
		TokenRoleSyntaxAttribute:    {Foreground: theme.Info},
		TokenRoleSyntaxParameter:    {Foreground: theme.Secondary},
		TokenRoleSyntaxString:       {Foreground: theme.Success},
		TokenRoleSyntaxNumber:       {Foreground: theme.Accent},
		TokenRoleSyntaxRegex:        {Foreground: theme.Warning},
		TokenRoleSyntaxStringEscape: {Foreground: theme.Warning},
		TokenRoleSyntaxTag:          {Foreground: theme.Accent},
		TokenRoleSyntaxComment:      {Foreground: theme.TextMuted, Italic: true},
		TokenRoleSyntaxOperator:     {Foreground: theme.Text},
		TokenRoleSyntaxPunctuation:  {Foreground: theme.Text},
	}
	applySyntaxThemeOverrides(theme, roleStyles)
